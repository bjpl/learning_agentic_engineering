...
receiver.on('message', (msg) => {
  ...
  const filteredFrameworks = useMemo(() => {
    // Combine all frameworks inside useMemo to ensure proper updates
    ...
    return filtered;
  }, [searchTerm, filterCategory, frameworks]);

  // Get all categories from frameworks
  const categories = useMemo(() => {
    const allFrameworks = [...frameworks.core, ...frameworks.specialized];
    const uniqueCategories = [...new Set(allFrameworks.map(f => f.category))].sort();
